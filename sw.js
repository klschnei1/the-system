const CACHE = 'css-v11';
const STATIC = ['datastore.js','sleeve-core.js','finance.js','forecast.js','intake.js','intellect.js','juice.js','sensei.js','sigils.js','strength.js','themes.js','icon.svg','manifest.json'];
